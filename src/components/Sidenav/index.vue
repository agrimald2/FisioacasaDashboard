      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">
            ...
            <span class="nav-link-text ms-1">Menu Example</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">
      ...
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div class="card-body text-left p-3 w-100">
          <div class="icon icon-shape icon-sm bg-white shadow text-center mb-3 d-flex align-items-center justify-content-center border-radius-md">
            <i class="fas fa-gem" style="font-size: 18px; color: black"></i>
          </div>
          <h6 class="text-white up mb-3">Need help?</h6>
          <a href="#" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Text</a>
        </div>
      </div>
    </div>
  </aside>
